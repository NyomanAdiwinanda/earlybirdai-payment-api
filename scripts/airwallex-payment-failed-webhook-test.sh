...
# Test Airwallex webhook for payment_attempt.failed_to_process event
...
curl -X POST http://localhost:3000/webhooks/payment \
  ...
  -d '{
    "id": "evt_100_2025081101549020043_8321220011893788",
...
echo ""
echo "Airwallex payment_attempt.failed_to_process webhook sent!"
